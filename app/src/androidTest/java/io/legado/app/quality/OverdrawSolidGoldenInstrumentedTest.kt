...
class OverdrawSolidGoldenInstrumentedTest {
    ...
    @Test
    fun solidRootBackgroundsMatchTheirWindowOrParent() {
    ...
    private fun launchFixture(fixture: String): GoldenFixtureActivity {
        ...
        assertNotNull("Overdraw golden fixture 未进入 RESUMED: $fixture", activity)
        SystemClock.sleep(500)
    ...
    companion object {
        ...
        private val FIXTURES = listOf(
            "overdraw_solid_activity",
            "overdraw_solid_items",
        )
    }
}
