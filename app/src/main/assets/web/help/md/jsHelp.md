...
> 注意为了安全，阅读会屏蔽部分 java 类调用，见 [RhinoClassShutter](https://github.com/coding-back01/legado/blob/master/modules/rhino/src/main/java/com/script/rhino/RhinoClassShutter.kt)
...
|result|上一步的结果|
|book|[书籍类](https://github.com/coding-back01/legado/blob/master/app/src/main/java/io/legado/app/data/entities/Book.kt)|
|rssArticle|[Article 类](https://github.com/coding-back01/legado/blob/master/app/src/main/java/io/legado/app/data/entities/RssArticle.kt)|
|chapter|[章节类](https://github.com/coding-back01/legado/blob/master/app/src/main/java/io/legado/app/data/entities/BookChapter.kt)|
|source|[基础书源类](https://github.com/coding-back01/legado/blob/master/app/src/main/java/io/legado/app/data/entities/BaseSource.kt)|
|cookie|[cookie 操作类](https://github.com/coding-back01/legado/blob/master/app/src/main/java/io/legado/app/help/http/CookieStore.kt)|
|cache|[缓存操作类](https://github.com/coding-back01/legado/blob/master/app/src/main/java/io/legado/app/help/CacheManager.kt)|
|title|章节当前标题 String|
|src| 请求返回的源码|
...
### [RssJsExtensions](https://github.com/coding-back01/legado/blob/master/app/src/main/java/io/legado/app/ui/rss/read/RssJsExtensions.kt)
> 只能在订阅源`shouldOverrideUrlLoading`规则中使用  
> 订阅添加跳转url拦截, js, 返回true拦截,js变量url,可以通过js打开url  
> url跳转拦截规则不能执行耗时操作
> 例子见[原项目历史讨论 #3259](https://github.com/gedoor/legado/discussions/3259)；该链接仅用于历史归属，原仓库撤空后可能无法访问。
...
### [AnalyzeUrl](https://github.com/coding-back01/legado/blob/master/app/src/main/java/io/legado/app/model/analyzeRule/AnalyzeUrl.kt) 部分函数
...
### [AnalyzeRule](https://github.com/coding-back01/legado/blob/master/app/src/main/java/io/legado/app/model/analyzeRule/AnalyzeRule.kt) 部分函数
* 获取文本/文本列表
...
### [js 扩展类](https://github.com/coding-back01/legado/blob/master/app/src/main/java/io/legado/app/help/JsExtensions.kt) 部分函数

* 链接解析 [JsURL](https://github.com/coding-back01/legado/blob/master/app/src/main/java/io/legado/app/utils/JsURL.kt)
```js
...
### [js 加解密类](https://github.com/coding-back01/legado/blob/master/app/src/main/java/io/legado/app/help/JsEncodeUtils.kt) 部分函数
