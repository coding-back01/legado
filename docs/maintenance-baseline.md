...
| `UseKtx` | 低 | 133 | 32 | 94 | 7 | 0 | 32 | PR 3 与 PR 4g 至 4k 已安全消除 91 项；PR 4l（#65）对 3 个非空 `Bitmap.toDrawable` occurrence 完成等价转换，对 7 个必须保留可空 Bitmap 构造语义的 occurrence 精确局部抑制；其余继续逐类审查 |
