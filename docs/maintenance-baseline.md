...
| `RtlHardcoded` | 中 | 7 | 0 | 7 | 0 | 0 | 0 | PR 4a 将物理方向间距与 gravity 改为逻辑方向；布局契约与 lint 已验证 |
| `RtlSymmetry` | 中 | 2 | 0 | 2 | 0 | 0 | 0 | PR 4a 为单侧逻辑内边距补齐显式零起始值；布局契约与 lint 已验证 |
...
| **合计** |  | **881** | **860** | **21** | **0** | **0** | **860** | 逐 ID 审查中；PR 3 与 PR 4a 已安全修复 21 项 |
