...
| `UseKtx` | 低 | 133 | 22 | 104 | 7 | 0 | 22 | PR 3 与 PR 4g 至 4k 已安全消除 91 项；PR 4l（#65）完成 3 个非空 Bitmap Drawable 转换并精确抑制 7 个可空兼容 occurrence；PR 4m 将 10 个 `ColorDrawable(Int)` occurrence 改为等价 `Int.toDrawable()`；其余继续逐类审查 |
